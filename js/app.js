 ...
 */            (function(window, factory) {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            let priceFrom = document.querySelector(".filter__inputs_start");
            let priceTo = document.querySelector(".filter__inputs_end");
            if (priceSlider) {
                nouislider.create(priceSlider, {
                    ...
                    start: [ +priceFrom.value, +priceTo.value ],
                    connect: true,
                    step: 1,
            ...
            let priceFrom2 = document.querySelector("[data-rangeFrom2]");
            let priceTo2 = document.querySelector("[data-rangeTo2]");
            if (priceSlider2) {
                ...
                valuesObj2.forEach((function(input, handle) {
                    input.addEventListener("change", (function() {
                        priceSlider2.noUiSlider.setHandle(handle, this.value);
                    }));
                }));
            }
            const priceSlider3 = document.querySelector("#range3");
            let priceFrom3 = document.querySelector("[data-rangeFrom3]");
            let priceTo3 = document.querySelector("[data-rangeTo3]");
            if (priceSlider3) {
                ...
                valuesObj3.forEach((function(input, handle) {
                    input.addEventListener("change", (function() {
                        priceSlider3.noUiSlider.setHandle(handle, this.value);
                    }));
                }));
            }
        }
        ...
        function initSliders() {
            if (document.querySelector(".touch") && window.innerWidth < 1440) if (document.querySelector(".main__slider")) new core(".main__slider", {
            ...
            if (document.querySelector(".tabs__slider.swiper")) new core(".tabs__slider.swiper", {
            ...
            if (document.querySelector(".sliders-swiper2")) var smallSlider = new core(".sliders-swiper2", {
            ...
            if (document.querySelector(".sliders-swiper1")) new core(".sliders-swiper1", {
        ...
        function setPraceValue() {
            const price = document.querySelectorAll(".tabs__price");
            const rent = document.querySelectorAll(".tabs__rent");
            for (let i = 0; i < price.length; i++) {
                let value = price[i].dataset.value;
                let html = price[i].innerHTML;
                price[i].innerHTML = html + " " + value;
            }
            for (let i = 0; i < rent.length; i++) {
                let value = rent[i].dataset.value;
                let html = rent[i].innerHTML;
                rent[i].innerHTML = html + " " + value;
                if ("n/a" == rent[i].dataset.value) rent[i].classList.add("disable"); else rent[i].classList.add("enable");
            }
        }
        setPraceValue();
        document.addEventListener("click", (function(e) {
            ...
            if (targetElement.closest(".subtabs__button")) {
                const subTabsButtons = document.querySelectorAll(".subtabs__button");
                for (let i = 0; i < subTabsButtons.length; i++) subTabsButtons[i].classList.remove("subtabs__button_active");
                targetElement.classList.add("subtabs__button_active");
            }
            if (targetElement.closest(".filter__clear")) {
                document.querySelector(".filter__clear");
                const form = document.querySelector(".filter");
                form.reset();
            }
        }));
        function gridInit() {
            const items = document.querySelector(".tabs__items");
            ...
            function documentAction(e) {
                ...
                if (targetElement.closest(".tabs__title")) {
                    const filterItem = targetElement.closest(".tabs__title");
                    const filterValue = filterItem.dataset.filter;
                    const filterActiveItem = document.querySelector(".tabs__title.tabs__active");
                    "*" === filterValue ? itemGrid.arrange({
                        filter: ``
                    }) : itemGrid.arrange({
                        filter: `[data-filter="${filterValue}"]`
                    });
                    filterActiveItem.classList.remove("tabs__active");
                    filterItem.classList.add("tabs__active");
                    e.preventDefault();
                }
            }
        }
        ...
        document.querySelector(".popup__touch").addEventListener("touchmove", (function(e) {
            console.log(e);
            const posbigY = e.targetTouches[0].screenY;
            const possmallY = e.targetTouches[0].clientY;
            const filter = document.querySelector(".popup");
            const window = document.documentElement;
            if (posbigY - possmallY > 100) {
                filter.classList.remove("popup_show");
                window.classList.remove("popup-show");
                window.classList.remove("lock");
            }
        }));
        ...
        function customTabs() {
            if (window.innerWidth < 768) {
                let tabItems = document.querySelectorAll(".tabs-catalog__title");
                for (let i = 0; i < tabItems.length; i++) tabItems[i].classList.add("_tab-active");
                let tabsContent = document.querySelectorAll("[data-tabs-item]");
                for (let i = 0; i < tabsContent.length; i++) tabsContent[i].removeAttribute("hidden");
            }
        }
        window.addEventListener("load", customTabs);
        window["FLS"] = true;
        isWebp();
        addTouchClass();
        tabs();
